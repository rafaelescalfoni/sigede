...
@Table(name = "unidade")
@NamedQueries({
    @NamedQuery(name = "Unidade.findAll", query = "SELECT un FROM Unidade un"),
    @NamedQuery(name = "Unidade.findById", query = "SELECT un FROM Unidade un WHERE un.id = :id"),
    @NamedQuery(name = "Unidade.findByNome", query = "SELECT un FROM Unidade un WHERE un.nome = :nome")})
public class Unidade implements Serializable {
    ...
    public String toString() {
        return "br.sigede.model.Unidade[ id=" + id + " ]";
    }
