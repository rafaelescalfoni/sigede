...
public class DAOGenerico<T> {
	 ...
	 * @param params
	 * @param namedQuery
	 * @param numLinhas - nï¿½mero mï¿½ximos de registros de resultado
	 * @return
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * Listar com NamedQueries e com um nï¿½mero de registros mï¿½ximos de resposta
	 * @param params
	 * @param namedQuery
	 * @param numLinhas
	 * @return
