            ...
            <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="<c:url value="#"/>">DEMAIS ÓRGÃOS</a></li>
                        </ul>
                </div>
                    ...
                    <div class="container-fluid">
                       ...
                       <div class="form-group">
                           <a href="<c:url value="/do/Do"/>" class="btn btn-warning btn-large"><i class="glyphicon glyphicon-chevron-left"></i> CANCELAR</a>
                           <br>
                       </div>
                    ...
                    <h4>CADASTRO DE DEMANDAS DOS DEMAIS ÓRGÃOS</h4>
