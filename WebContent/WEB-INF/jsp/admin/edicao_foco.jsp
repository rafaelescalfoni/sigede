	                	...
	                	<div class="tab-pane fade in active" id="tab1primary">
	                    	<div class="container-fluid">
	                            <div class="tab-content"> 
	                        		<br>
	                       			<div class="form-group">
	                           			<a href="<c:url value="/admin/suporte/foco"/>" class="btn btn-warning btn-large">
	                        	...
	                        	<div class="tab-content2">
	                    			<h4>CADASTRO DO FOCO DA AUDITORIA</h4>
	                    		</div>
	                      		<form class="form-inline" role="form" action="<c:url value="/suporte/foco/${foco.id}"/>" method="post">
	                            	<!-- Select Basic -->
	                             	<div class="tab-content3">
	                        			<div class="form-group">
	                            			<div class="control-label">
	                                    		<label for="foco.nome">Nome</label>
	                            			</div> 
	                            			<div class="control-label">
	                                    		<input type="text" class="form-controln" name="foco.nome" value="${foco.nome}">
	                                  		</div>
	                        			</div>
	                                 	<br><br>
	                                 	<div class="form-group">
