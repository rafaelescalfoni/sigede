	                	...
	                	<div class="tab-pane fade in active" id="tab1primary">
	                    	<div class="container-fluid">
	                            <div class="tab-content"> 
	                        		<br>
	                       			<div class="form-group">
	                           			<a href="<c:url value="/admin/suporte/colegiado"/>" class="btn btn-warning btn-large">
	                        	...
	                        	<div class="tab-content2">
	                    			<h4>CADASTRO DO COLEGIADO DO TRIBUNAL DE CONTAS DA UNIÃO (TCU)</h4>
	                    		</div>
	                      		<form class="form-inline" role="form" action="<c:url value="/suporte/colegiado/{colegiado.id}"/>" method="post">
	                            	<!-- Select Basic -->
	                             	<div class="tab-content3">
	                        			<div class="form-group">
	                            			<div class="control-label">
	                                    		<label for="colegiado.nome">Nome</label>
	                            			</div> 
	                            			<div class="control-label">
	                                    		<input type="text" class="form-controln" name="colegiado.nome" value="${colegiado.nome}">
	                                  		</div>
	                        			</div>
	                                 	<br><br>
	                                 	<div class="form-group">
