		...
		<div class="container">
			<div class="col-md-12">
				<div class="panel with-nav-tabs panel-primary">
					<c:import url="../jspf/abas_suporte_areatematica.jsp"></c:import>
							...
							<div class="container-fluid">
								<div class="tab-content">
									...
									<div class="form-group">
										<a href="<c:url value="/admin/areatematica/cadastrar_areatematica"/>"
											class="btn btn-success"> <i
											class="glyphicon glyphicon-plus"></i> CADASTRAR ÁREA TEMÁTICA
										</a> <br>
									</div>
								</div>
								<div class="tab-content2">
									<h4>CONSULTA POR ÁREA TEMÁTICA</h4>
								</div>
									...
									<div class="tab-content3">
										<div class="form-group">
											<div class="control-label">
												<label>SELECIONE A ÁREA TEMÁTICA</label>
											</div>
											...
											<tbody>
												<c:forEach items="${areatematicaList}" var="areatematica">
													<tr>
														...
														<td><a href="<c:url value="/admin/suporte/areatematica/${areatematica.id}/update"/>">
