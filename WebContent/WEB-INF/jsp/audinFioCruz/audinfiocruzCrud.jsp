						...
						<div class="tab-pane fade in active" id="tab1primary">
							<div class="container-fluid">
								...
								<div class="tab-content2">
									<h4>CONSULTA POR DEMANDAS ORIGINADAS DA AUDITORIA INTERNA (AUDIN)</h4>
								</div>
									...
									<div class="tab-content3">
										...
										<div class="form-group">
											...
											<select class="form-control">
												...
												<option value="Afastamento do País">Afastamento do País</option>
										...
										<table class="table table-striped">
											...
											<tbody>
												<c:forEach items="${demandaList}" var="demanda" >
													<tr>
														<td>${demanda.tipodemanda} de ${demandaaudin.tiporelatorioaudin} nº ${demanda.num_demanda}/${demanda.ano}</td>
														<td>${demandaaudin.unidadeauditada}</td>
														<td>${demandaaudin.foco}</td>
														<td>${registrodemanda.assunto}</td>
														<td>${registrodemanda.statusregistro}</td>
														<td>
															<a href="<c:url value="/demandas/audinfiocruz/${demanda.id}/update"/>">
